...
import { convertParameterValue, convertToolParameters, convertPromptArguments, } from "../json/jsonUtils.js";
describe("JSON Utils", () => {
    describe("convertParameterValue", () => {
        ...
        it("should parse JSON strings", () => {
            expect(convertParameterValue('{"key":"value"}', { type: "object" })).toEqual({
                key: "value",
            });
...
//# sourceMappingURL=jsonUtils.test.js.map