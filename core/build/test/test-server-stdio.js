...
import { getDefaultServerConfig, createMcpServer, } from "./test-server-fixtures.js";
 ...
 */
export function createTestServerStdio(config) {
 ...
 */
export function getTestMcpServerPath() {
    return fileURLToPath(import.meta.url);
}
/**
 * Get the command and args to run the test MCP server
 */
export function getTestMcpServerCommand() {
    return {
        command: "tsx",
...
//# sourceMappingURL=test-server-stdio.js.map