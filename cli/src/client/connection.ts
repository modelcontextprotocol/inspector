...
export async function connect(client: Client, transport: Transport): Promise<void>
{
    try
    {
...
// Set logging level
export async function setLoggingLevel(client: Client, level: LogLevel): Promise<McpResponse>
{
    try
    {
