...
import { callTool, connect, disconnect, getPrompt, listPrompts, listResources, listResourceTemplates, listTools, LogLevel, McpResponse, readResource, setLoggingLevel, validLogLevels } from "./client/index.js";
...
async function callMethod(args: Args): Promise<void>
{
    ...
    const client = new Client({ name: packageInfo.name, version: packageInfo.version });
...
function parseKeyValuePair(value: string, previous: Record<string, string> = {}): Record<string, string>
{
...
function parseArgs(): Args
{
    ...
    program
        ...
        .option("--tool-args <pairs...>", "Tool arguments as key=value pairs", parseKeyValuePair, {})
        //
        ...
        // Logging options
        //
        .option("--log-level <level>", "Logging level (for logging/setLevel method)", (value: string) =>
        {
