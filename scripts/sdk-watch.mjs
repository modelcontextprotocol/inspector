...
export function buildIssueBody(state) {
  ...
  return [
    ...
    "- [ ] Re-check the bundler `external` lists (`clients/{cli,daemon-cli,tui}/tsup.config.ts`, `clients/web/tsup.runner.config.ts`) if the release adds or renames an entry point; `npm run verify:bundle-externals` enforces this against the built output.",
