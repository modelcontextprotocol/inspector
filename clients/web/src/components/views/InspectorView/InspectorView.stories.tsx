...
const meta: Meta<typeof InspectorView> = {
  ...
  args: {
    ...
    onSelectTool: fn(),
    onToolFormChange: fn(),
    onToolSearchChange: fn(),
    onCallTool: fn(),
    onRefreshTools: fn(),
    onSelectedPromptNameChange: fn(),
    onPromptArgumentValuesChange: fn(),
    onPromptSubmittedForChange: fn(),
    onPromptSearchChange: fn(),
    onGetPrompt: fn(),
    onRefreshPrompts: fn(),
    onSelectedResourceUriChange: fn(),
    onSelectedTemplateUriChange: fn(),
    onOriginatingTemplateUriChange: fn(),
    onResourceSearchChange: fn(),
    onResourceOpenSectionsChange: fn(),
    onReadResource: fn(),
    onSubscribeResource: fn(),
    onUnsubscribeResource: fn(),
    onRefreshResources: fn(),
    onTaskSearchChange: fn(),
    onTaskStatusFilterChange: fn(),
    onCancelTask: fn(),
    onClearCompletedTasks: fn(),
    onRefreshTasks: fn(),
    onSetLogLevel: fn(),
    onLogFilterChange: fn(),
    onLogVisibleLevelsChange: fn(),
    onClearLogs: fn(),
    onExportLogs: fn(),
    onHistorySearchChange: fn(),
    onHistoryMethodFilterChange: fn(),
    onClearHistory: fn(),
    onExportHistory: fn(),
    onReplayHistory: fn(),
    onTogglePinHistory: fn(),
    onNetworkFilterChange: fn(),
    onNetworkVisibleCategoriesChange: fn(),
    onClearNetwork: fn(),
    onExportNetwork: fn(),
    onSelectedAppNameChange: fn(),
    onAppFormValuesChange: fn(),
    onAppSearchChange: fn(),
    onSelectApp: fn(),
    onOpenApp: fn(),
    onCloseApp: fn(),
    onAppError: fn(),
