...
const meta: Meta<typeof InlineSamplingRequest> = {
  ...
  args: {
    ...
    messagePreview: 'Please analyze the following code and suggest improvements for performance and readability.',
    responseText: '',
    onAutoRespond: fn(),
    onEditAndSend: fn(),
    onReject: fn(),
...
export const PrefilledResponse: Story = {
  args: {
    responseText: 'The code looks good overall. Consider extracting the repeated logic into a helper function.',
  },
}
