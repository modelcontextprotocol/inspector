...
There are some test mcp.json files in `configs/`:

- `configs/mcp.json` - Sample test servers
- `configs/mcpapps.json` - All MCP Apps test servers

You can use them (or any mcp.json file) like this:

- `npm run web -- --config configs/mcpapps.json --server basic-solid`
