...
This V2 rebuild of the MCP Inspector reimagines the platform with a focus on maintainability and improved user experience.
...
- Use type annotations and interfaces to improve code clarity and maintainability
...
Currently, the V2 project exists on the `v2/main` branch but when completed, it will reside on the `main` branch, and what
is there will be moved to a `v1.x/main` branch.
...
├── specification/                     
│   ├── README.md                       
│   ├── v1_problems.md          # Problems in V1 to be avoided
│   ├── v2_scope.md             # Scope of the V2 Inspector
│   ├── v2_screenshots.md       # Screenshots of the V2 Inspector mockups
│   ├── v2_storage.md           # Storage and state management
